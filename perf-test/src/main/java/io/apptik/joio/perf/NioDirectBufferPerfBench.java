...
public class NioDirectBufferPerfBench {
   ...
   */
    ...
    @Benchmark
    @Threads(1)
    public void nioDirect_threads1hot(HotBuffers buffers) throws IOException {
        readWriteRecycle(buffers);
    }

    @Benchmark
    @Threads(2)
    public void nioDirect_threads2hot(HotBuffers buffers) throws IOException {
        readWriteRecycle(buffers);
    }

    @Benchmark
    @Threads(4)
    public void nioDirect_threads4hot(HotBuffers buffers) throws IOException {
        readWriteRecycle(buffers);
    }

    @Benchmark
    @Threads(8)
    public void nioDirect_threads8hot(HotBuffers buffers) throws IOException {
        readWriteRecycle(buffers);
    }

    @Benchmark
    @Threads(16)
    public void nioDirect_threads16hot(HotBuffers buffers) throws IOException {
        readWriteRecycle(buffers);
    }

    @Benchmark
    @Threads(32)
    public void nioDirect_threads32hot(HotBuffers buffers) throws IOException {
        readWriteRecycle(buffers);
    }
    ...
    @GroupThreads(3)
    @Group("cold")
    public void nioDirect_thinkReadCold(HotBuffers buffers) throws IOException {
    ...
    @GroupThreads(3)
    @Group("cold")
    public void nioDirect_thinkWriteCold(ColdBuffers buffers) throws IOException {
   ...
   */
    ...
    public static class ColdBuffers extends BufferSetup {
        ...
        @Setup(Level.Trial)
        public void setupBench(NioDirectBufferPerfBench bench) {
    ...
    public static class BufferState {
        NioDirectBufferPerfBench bench;

        public void setupBench(NioDirectBufferPerfBench bench) {
            this.bench = bench;
            received = ByteBuffer.allocateDirect(bench.requestSize);
            sent = ByteBuffer.allocateDirect(bench.requestSize);
            process = ByteBuffer.allocateDirect(bench.requestSize);
        }
